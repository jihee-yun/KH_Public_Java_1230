...
public class IPadPro {
    ...
    String serialNum; // 제품일련번호 : iPad13128C2301111
    ...
    void setScreen() {
        ...
        while (true) {
            ...
            System.out.print("디스플레이를 다시 선택하세요.");
        }
    }
    void setColor() {
        Scanner sc = new Scanner(System.in);
    ...
    void setNetwork() {
        ...
        while (true) {
            ...
            System.out.println("네트워크를 다시 입력하세요.");
        }
    }
    void setName() {
        Scanner sc = new Scanner(System.in);
    ...
    void viewProductPad() {
        ...
        System.out.println("제품 네트워크 : " + netType[network]);
