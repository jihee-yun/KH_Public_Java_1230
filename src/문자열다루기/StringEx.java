...
public class StringEx {
    public static void main(String[] args) {
        // equals() : 두개의 문자열 동일 여부를 비교하여 결과를 반환
        String a = "hello";
        String b = "java";
        String c = "hello";
//        System.out.println(a.equals(b)); // a 문자열과 b 문자열을 비교, 같으면 true 다르면 false
//        System.out.println(a.equals(c)); //
//        System.out.println(a.equalsIgnoreCase("HELLO")); // 대,소문자 무시
//        System.out.println(a == c); // 주소값 비교(얕은 복사)

        // indexOf() : 문자열에서 특정문자가 시작되는 인덱스를 반환 (인덱스는 0부터 시작)
        String d = "Hello Java";
        System.out.println(d.indexOf("Java"));

        // contains() : 문자열에서 특정 문자열 포함여부를 리턴 (대소문자 구분)
        ...
        // substring(시작인덱스) : 문자열에서 특정 문자를 추출할 때 사용 (시작인덱스부터 끝까지)
        // sunstring(시작인덱스, 종료인덱스) :
