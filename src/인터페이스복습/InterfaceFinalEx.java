...
// 인터페이스에 포함된 메소드는 기본적으로 추상 메소드 (구현부 없음)
// 구현부가 없기 때문에 인터페이스 메소드를 상속받은 클래스는 반드시 해당 메소드를 구현해야 함
...
public class InterfaceFinalEx {
    public static void main(String[] args) {
        ...
        System.out.print("네트워크 [1]WiFi [2]FiveG : ");
        int sel = sc.nextInt();
...
class FiveG implements NetAdapter {
    ...
    @Override
    public void connect() {
        System.out.println("FiveG 연결 성공");
    }
