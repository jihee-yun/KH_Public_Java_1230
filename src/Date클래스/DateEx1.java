package Date클래스;
// Date 클래스 : 1970년 1월1일 0시0분0초로부터 msec 단위로 경과 시간을 운영체제로부터 얻어 낸다
// SimpleDateFormat 클래스 : 얻은 시간 정보를 우리가 원하는 날짜와 시간 형태로 변환하여 출력하는 포맷
...
public class DateEx1 {
    public static void main(String[] args) {
        ...
        // yy : 연도를 2자리로 표현(23)
        // MM : 월을 표시(월이 한자리인 경우 앞에 0 포함, 반드시 대문자)
        // mm : 분을 표시(분이 한자리인 경우 앞에 0 포함, 반드시 소문자)
        // HH : 24시간제 표시
        // hh : 12시간제 표시
        // W : 월에서 몇주차인지 표시
        // w : 년에서 몇주차인지 표시
        ...
        f6 = new SimpleDateFormat("오늘은 M월 W번째 주, d번째 날 입니다.");
