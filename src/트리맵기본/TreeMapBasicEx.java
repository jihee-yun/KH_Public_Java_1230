...
// TreeMap : TreeSet 과 마찬가지로 이진 검색 트리로 구현되어 있다
// TreeSet 과 차이는 키와 값으로 구성된 Map.Entry 를 저장
// 부모 키값 기준으로 작은 건 왼쪽 큰 건 오른쪽으로 자동 저장
public class TreeMapBasicEx {
    public static void main(String[] args) {
        ...
        entry = score.lowerEntry(95); // 주어진 값 바로 아래 값을 리턴
        System.out.println("바로 아래 점수 : " + entry.getKey() + " : " +  entry.getValue());
        entry = score.higherEntry(95); // 주어진 값 바로 위 값을 리턴
